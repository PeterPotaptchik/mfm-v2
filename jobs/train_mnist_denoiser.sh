...
job_commands=()
job_commands+=("python scripts/train_denoiser.py model=unet_mnist_denoiser dataset=mnist ++sde.noise_schedule=linear ++trainer.num_train_steps=100000 ++trainer.batch_size=256")
