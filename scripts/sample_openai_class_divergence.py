...
def main(cfg: DictConfig):
    ...
    conditional_score_fn = get_iwae_score_fn(dist_model,
                                             ...
                                             type="cfm",)
    baseline_score_fn = get_dps_score_fn(uncond_model_fn,
                                         sde,
                                         classifier_fn,
                                         datamodule.inverse_scaler,)
    comparative_dir = f"./outputs/{cfg.dataset}"
    ...
    samples_dir = os.path.join(comparative_dir, f"class_conditional_{time_str}")
